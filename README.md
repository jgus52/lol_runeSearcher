# League of Legends Oppose Rune Searcher

Enemy에서 닉네임을 검색하면 상대 팀의 룬 정보와 랭크게임 리그 정보, 챔피언 승률
을 보여줍니다.
...
챔피언과 실제 게임 내역과 관련된 내용은 개인용 api로 처리하는데 2분 당 200
request로 제한이 있어 제대로 출력하지 못하여 제외하고 배포했습니다.
